...
$copyright = $copyright ? $copyright : '©2017 <a href="http://www.xxx.com" target="_blank">云上信息科技</a>';
?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <title><?= !empty($this->title) ? $this->title . ' - ' : null ?><?= Option::get('name', 0, 'admin', '云上信息科技') ?></title>
