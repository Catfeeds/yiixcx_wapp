...
class UserRechargeForm extends MchModel
{
    ...
    public function search()
    {
        ...
        $select = 'id,store_id,user_id, integral as pay_price,addtime as pay_time,content as order_no,content as re_content';
        ...
        $select = 'id,store_id,user_id, pay_price,pay_time,order_no,re_content,send_price,pay_type';
