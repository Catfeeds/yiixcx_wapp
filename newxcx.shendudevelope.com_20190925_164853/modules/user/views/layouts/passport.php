...
<head>
    ...
    <link rel="stylesheet" href="<?= Yii::$app->request->baseUrl ?>/statics/admin/css/login.css?v=<?= $version ?>">
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>/statics/admin/js/jquery-migrate-1.2.1.js?v=<?= $version ?>"></script>
    <script src="<?= Yii::$app->request->baseUrl ?>/statics/admin/js/jquery.progressBar.js?v=<?= $version ?>"></script>
